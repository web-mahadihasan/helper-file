...
const ProductsModalTest3 = ({
  ...
  const {
    ...
    refetch, // <-- get refetch if available
  } = useAppQuery({
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      // Force refetch to avoid cache flash
      if (typeof refetch === "function") refetch();
    }
  }, [isOpen, selectedProducts, refetch]);
  ...
  const handleScroll = (e) => {
    ...
    // Only fetch if user is at the bottom (within 40px)
        ...
        >
          <Flex justify="space-between" align="center">
            <Text fontSize="md" fontWeight="semibold">
              Add products ({selection.length}/{maxProductSelect || 1}) test 3
            </Text>
...
export default ProductsModalTest3;
